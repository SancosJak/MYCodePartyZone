...
public interface IAdministrator extends IUser {
    ...
    IFilm createFilm(String name, int duration, String genre, String rating, String description, String language);
    ...
    ISession createSession(IFilm film, ICinemaHall cinemaHall, String startTime, String endTime);

...
public class IOExamples {
    ...
    public static void readBytesFromFile() {
        try (FileInputStream fis = new FileInputStream("ClassWorks/lesson57/l57cw/practice/input.txt")) {
            int data;
    ...
    public static void writeBytesToFile() {
        try (FileOutputStream fos = new FileOutputStream("ClassWorks/lesson57/l57cw/practice/output.txt")) {
    ...
    public static void readTextFromFile() {
        try (BufferedReader br = new BufferedReader(new FileReader("ClassWorks/lesson57/l57cw/practice/input.txt"))) {
            String line;
    ...
    public static void writeTextToFile() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("ClassWorks/lesson57/l57cw/practice/output.txt"))) {

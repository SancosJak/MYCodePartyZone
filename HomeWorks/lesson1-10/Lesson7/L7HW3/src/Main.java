...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        if ((priceA < 0) || (n1 < 0) || (discountA < 0) || (priceB < 0) || (n2 < 0) || (discountB < 0))
            System.out.println("Ошибка!!! Неправильно введенные данные!!! P.S. Стоимость, количество товаров и скидка не может быть отрицательным числом");
        else {
